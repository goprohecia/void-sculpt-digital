...
export const MOCK_ENTERPRISES: MockEnterprise[] = [
  ...
  { id: "5", nom: "CleanPro", email: "admin@cleanpro.fr", plan: "enterprise", users: 15, modules: ["clients", "dossiers", "facturation", "messagerie", "relances", "support", "stock", "analyse", "taches", "automatisations"], mrr: 400, statut: "actif", date: "2025-08-05", sector: "nettoyage", swapsRemaining: 2, deblocages: 0 },
