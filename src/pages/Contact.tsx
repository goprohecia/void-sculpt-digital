            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <ScrollReveal variant="fadeInLeft" delay={0.2}>
                  <Hover3DCard className="rounded-xl" rotateStrength={5}>
                    <div className="flex items-start gap-4 group p-4 rounded-xl bg-glass-dark/40 border border-white/5 hover:border-emerald-500/30 transition-all">
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <RippleButton
                          type="submit"
                          disabled={isLoading}
                          className="group w-full md:w-auto btn-gradient px-8 py-4 text-white font-semibold rounded-xl inline-flex items-center justify-center gap-2 relative overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed"
                        >
