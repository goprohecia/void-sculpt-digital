      ...
      case "timeline":
        return (
          <div className="space-y-5">
            <div>
              {/* [MBA] Fusion livraison + suivi en une seule section "Timeline de suivi" */}
              <h2 className="text-lg font-semibold flex items-center gap-2">
                <Clock className="h-5 w-5 text-primary" /> Timeline de suivi
              </h2>
              <p className="text-sm text-muted-foreground mt-1">
                Personnalisez les étapes de suivi de vos dossiers.
              </p>
            </div>
