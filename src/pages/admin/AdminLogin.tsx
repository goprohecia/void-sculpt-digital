    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-3">
      <div className="w-full max-w-md space-y-4">
        ...
        <div className="text-center space-y-1">
          ...
          <h1 className="text-xl font-bold">Back-office Impartial</h1>
        </div>
        ...
        <div className="glass-card p-5 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <Input type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="glass-input border-0 h-9 text-sm pr-9" required />
            ...
            <Button type="submit" className="w-full h-9 gap-2 text-sm">
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button onClick={() => fillDemo("admin")} className="glass-button p-2.5 text-left space-y-0.5 hover:border-primary/30">
                <p className="text-xs font-semibold text-primary">Admin</p>
                <p className="text-[10px] text-muted-foreground">admin@impartial.demo</p>
              </button>
              <button onClick={() => fillDemo("client")} className="glass-button p-2.5 text-left space-y-0.5 hover:border-primary/30">
