...
import { rendezVous } from "@/data/mockData";
import { format, parseISO, startOfMonth, endOfMonth, eachDayOfInterval, getDay, addMonths, subMonths, isSameMonth, isSameDay, isToday } from "date-fns";
...
export default function AdminRendezVous() {
  ...
  const getRdvForDay = (day: Date) =>
    rendezVous.filter((r) => isSameDay(parseISO(r.date), day));
      ...
      <AdminPageTransition>
        <motion.div className="space-y-6" variants={staggerContainer} initial="initial" animate="animate">
          <motion.div variants={staggerItem}>
            ...
            <p className="text-muted-foreground text-sm">Vue d'ensemble des rendez-vous clients</p>
          </motion.div>
