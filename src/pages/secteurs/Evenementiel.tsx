      ...
      useCases={[
        {
          ...
          description: "Créez un dossier par événement avec brief client, budget, checklist, timeline et documents associés.",
        },
        {
          icon: Users,
          title: "Gestion des prestataires",
          description: "Centralisez votre carnet de prestataires (traiteurs, photographes, lieux…), comparez les devis et suivez les confirmations.",
        },
        {
          icon: CalendarDays,
          title: "Planning & coordination",
          description: "Planifiez chaque étape de l'événement, assignez les tâches à votre équipe et suivez l'avancement en temps réel.",
        },
        {
          icon: Receipt,
          title: "Devis & facturation clients",
          description: "Établissez des devis détaillés par poste, gérez les acomptes et facturez vos clients automatiquement à chaque jalon.",
        },
      ]}
      modules={[
