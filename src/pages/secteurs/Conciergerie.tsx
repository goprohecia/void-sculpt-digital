      ...
      useCases={[
        {
          ...
          description: "Suivez chaque propriété avec ses caractéristiques, documents et historique d'interventions. Organisez votre parc immobilier en quelques clics.",
        },
        {
          icon: Users,
          title: "Suivi des locataires",
          description: "Centralisez les informations de vos locataires, contrats de bail, états des lieux et communications dans un dossier unique.",
        },
        {
          icon: Wrench,
          title: "Gestion des interventions",
          description: "Créez et assignez des interventions techniques, suivez leur avancement et gardez un historique complet pour chaque bien.",
        },
        {
          icon: Receipt,
          title: "Facturation propriétaires",
          description: "Générez automatiquement les factures pour vos propriétaires avec le détail des prestations, commissions et charges refacturées.",
        },
      ]}
      modules={[
