      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <ScrollReveal variant="fadeInLeft">
            <Link to="/portfolio" className="inline-flex items-center gap-2 text-muted-foreground hover:text-amber-400 transition-colors mb-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <ScrollReveal variant="fadeInUp" delay={0.4}>
                <a href={projectDetails.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500/20 border border-amber-500/50 text-amber-400 font-semibold rounded-xl hover:bg-amber-500/30 transition-all">
                  Visiter le site
            ...
            <ScrollReveal variant="fadeInRight">
              <Hover3DCard className="rounded-2xl" rotateStrength={5}>
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(245,158,11,0.2)]">
                  <img src={wecloseImg} alt={projectDetails.title} className="w-full h-auto" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal variant="fadeIn" delay={0.2}>
              <div className="flex flex-wrap justify-center gap-4">
                {projectDetails.technologies.map((tech, index) => <motion.div key={tech} className="px-6 py-3 bg-glass-dark/60 backdrop-blur-xl rounded-xl border border-white/10 hover:border-amber-500/40 transition-all" initial={{
                opacity: 0,
                scale: 0.8
              }} whileInView={{
                opacity: 1,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal variant="scaleIn" duration={0.8}>
            <div className="bg-glass-dark/60 backdrop-blur-xl rounded-3xl p-12 text-center max-w-3xl mx-auto border border-white/10">
              ...
              <RippleButton onClick={() => window.location.href = "/contact"} className="px-8 py-4 bg-amber-500/20 border border-amber-500/50 text-amber-400 font-semibold rounded-xl hover:bg-amber-500/30 transition-all">
                Démarrer un projet
              </RippleButton>
            </div>
          </ScrollReveal>
