...
import { ArrowLeft, ExternalLink, Calendar, Users, Zap, Gamepad2, Check, Trophy, Gift, Users2 } from "lucide-react";
...
L'objectif était de créer une expérience gaming haut de gamme qui engage les joueurs et les récompense pour leur participation active à la communauté. L'interface devait être à la fois spectaculaire et fonctionnelle, avec des animations fluides et une navigation intuitive.`,
  challenges: ["Créer une expérience gaming immersive et engageante", "Développer un système d'invitation et de rewards robuste", "Intégrer des fonctionnalités Web3 pour les récompenses", "Gérer une communauté active avec des fonctionnalités sociales"],
  solutions: ["Interface gaming avec effets visuels premium", "Architecture backend scalable pour le système de points", "Smart contracts pour les rewards tokenisés", "Système de gamification avec leaderboards et achievements"],
  technologies: ["React", "TypeScript", "Node.js", "PostgreSQL", "Web3.js", "Socket.io", "Redis"],
  features: ["Système d'invitation viral", "Programme de rewards", "Leaderboards temps réel", "Profils utilisateurs complets", "Intégration Web3", "Chat communautaire"],
  results: [{
    metric: "10K+",
    label: "Utilisateurs actifs"
  }, {
    metric: "50K+",
    label: "Invitations générées"
  }, {
    metric: "95%",
    label: "Rétention utilisateurs"
  }, {
    metric: "4.9",
    label: "Note moyenne"
  }],
  gamingFeatures: [{
    icon: Trophy,
    title: "Compétitions",
    description: "Tournois et classements pour les meilleurs joueurs"
  }, {
    icon: Gift,
    title: "Rewards",
    description: "Système de récompenses tokenisées et exclusives"
  }, {
    icon: Users2,
    title: "Communauté",
    description: "Espaces sociaux pour connecter les joueurs"
  }]
};
export default function PropheciaProject() {
  return <Layout>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-cyan-600/15 rounded-full blur-[120px] animate-pulse-glow" style={{
        animationDelay: "1s"
      }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <ScrollReveal variant="fadeInLeft">
            <Link to="/portfolio" className="inline-flex items-center gap-2 text-muted-foreground hover:text-emerald-400 transition-colors mb-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <ScrollReveal variant="fadeInUp" delay={0.4}>
                <a href={projectDetails.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-500/20 border border-emerald-500/50 text-emerald-400 font-semibold rounded-xl hover:bg-emerald-500/30 transition-all">
            ...
            <ScrollReveal variant="fadeInRight">
              <Hover3DCard className="rounded-2xl" rotateStrength={8}>
                <div className="relative rounded-2xl overflow-hidden border-2 border-emerald-500/30 shadow-[0_0_80px_rgba(16,185,129,0.3)]">
                  <img src={propheciaLogo} alt="Guardian Of Prophecia" className="w-full h-auto object-cover" />
      ...
      <SectionTransition className="py-16 relative" parallaxStrength={0.05}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {projectDetails.gamingFeatures.map((feature, index) => <ScrollReveal key={feature.title} variant="fadeInUp" delay={index * 0.1}>
                <Hover3DCard className="rounded-xl h-full">
                  <div className="p-8 bg-glass-dark/60 backdrop-blur-xl rounded-xl border border-white/10 hover:border-emerald-500/40 transition-all h-full text-center group">
                    <motion.div className="w-16 h-16 rounded-2xl bg-emerald-500/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform" whileHover={{
                  rotate: 10
                }}>
            ...
            {projectDetails.results.map((result, index) => <ScrollReveal key={result.label} variant="scaleIn" delay={index * 0.1}>
                <Hover3DCard className="rounded-xl">
                  <div className="p-6 bg-glass-dark/60 backdrop-blur-xl rounded-xl border border-white/10 text-center hover:border-emerald-500/40 transition-all">
                    <motion.div className="text-3xl md:text-4xl font-bold text-emerald-400 mb-2" initial={{
                  scale: 0
                }} whileInView={{
                  scale: 1
                }} transition={{
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal variant="fadeIn" delay={0.2}>
              <div className="flex flex-wrap justify-center gap-4">
                {projectDetails.technologies.map((tech, index) => <motion.div key={tech} className="px-6 py-3 bg-glass-dark/60 backdrop-blur-xl rounded-xl border border-white/10 hover:border-emerald-500/40 transition-all" initial={{
                opacity: 0,
                scale: 0.8
              }} whileInView={{
                opacity: 1,
      ...
      <SectionTransition className="py-16 relative" parallaxStrength={0.05}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {projectDetails.features.map((feature, index) => <ScrollReveal key={feature} variant="fadeInUp" delay={index * 0.1}>
                <Hover3DCard className="rounded-xl">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal variant="scaleIn" duration={0.8}>
            <div className="bg-glass-dark/60 backdrop-blur-xl rounded-3xl p-12 text-center max-w-3xl mx-auto border border-white/10">
              ...
              <RippleButton onClick={() => window.location.href = "/contact"} className="px-8 py-4 bg-emerald-500/20 border border-emerald-500/50 text-emerald-400 font-semibold rounded-xl hover:bg-emerald-500/30 transition-all">
                Démarrer un projet
              </RippleButton>
            </div>
          </ScrollReveal>
