...
const MOCK_ENTERPRISES = [
  ...
  { nom: "CleanPro", plan: "enterprise", users: 15, mrr: 400, statut: "actif", date: "2025-08-05", sector: "conciergerie-nettoyage" },
  ...
  { nom: "ConciergeVIP", plan: "starter", users: 1, mrr: 150, statut: "actif", date: "2026-01-20", sector: "conciergerie-immo" },
