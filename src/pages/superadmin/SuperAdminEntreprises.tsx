...
const MOCK_ENTERPRISES = [
  { id: "1", nom: "TechVision SAS", email: "contact@techvision.fr", plan: "enterprise", users: 12, modules: 22, mrr: 400, statut: "actif", date: "2025-09-15" },
  { id: "2", nom: "Studio Créatif", email: "hello@studiocrea.com", plan: "business", users: 5, modules: 6, mrr: 250, statut: "actif", date: "2025-11-02" },
  { id: "3", nom: "BTP Renov", email: "info@btprenov.fr", plan: "starter", users: 2, modules: 3, mrr: 150, statut: "actif", date: "2026-01-10" },
  { id: "4", nom: "Immo+", email: "contact@immoplus.fr", plan: "business", users: 8, modules: 6, mrr: 250, statut: "actif", date: "2025-10-20" },
  { id: "5", nom: "CleanPro", email: "admin@cleanpro.fr", plan: "enterprise", users: 15, modules: 22, mrr: 400, statut: "actif", date: "2025-08-05" },
  { id: "6", nom: "DigitalCraft", email: "team@digitalcraft.io", plan: "starter", users: 1, modules: 3, mrr: 150, statut: "essai", date: "2026-02-28" },
  { id: "7", nom: "EventPro", email: "contact@eventpro.fr", plan: "business", users: 4, modules: 5, mrr: 250, statut: "actif", date: "2026-01-15" },
  { id: "8", nom: "CoachFit", email: "hello@coachfit.com", plan: "starter", users: 1, modules: 3, mrr: 150, statut: "actif", date: "2026-02-01" },
];
