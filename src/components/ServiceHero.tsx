      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div 
            ...
            style={{ transform: `translateY(${parallaxSlow * -0.5}px) scale(${1 - Math.abs(parallaxSlow) * 0.001}) rotate(${parallaxSlow * 0.02}deg)` }}
          >
            <div 
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8 lg:gap-12">
          ...
          <ScrollReveal variant="fadeInRight" delay={0.3}>
            <motion.div 
              ...
              style={{ transform: `translateY(${parallaxSlow * -1}px)`, opacity: Math.max(0, 1 - Math.abs(parallaxSlow) * 0.005) }}
