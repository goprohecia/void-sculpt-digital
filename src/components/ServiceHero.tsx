...
export function ServiceHero({
  ...
  return <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Logo - Fully centered */}
        <div className="mb-6 md:mb-10 lg:mb-12 flex justify-center" style={{
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-8 lg:gap-12">
          ...
          opacity: Math.max(0, 1 - Math.abs(parallaxSlow) * 0.006)
            ...
            {/* Badge */}
            {badge && <div className="mb-4 md:mb-6 flex justify-center lg:justify-start opacity-0 animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <div className={`group flex-shrink-0 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 animate-float rounded-full overflow-hidden border-2 md:border-4 transition-all duration-500 ${borderClasses[accentColor]}`} style={{
