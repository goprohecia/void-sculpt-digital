import { DJ_STEPS } from "@/data/mockDJData";
import { Check, FileText, Send, FileSignature, Euro, CalendarCheck, Music, Flag } from "lucide-react";
import { cn } from "@/lib/utils";

const STEP_ICONS = [FileText, Send, FileSignature, Euro, CalendarCheck, Music, Flag];

interface Props { currentStep: number; }

export function DJStepper({ currentStep }: Props) {
  return (
    <div className="flex items-center gap-1 w-full overflow-x-auto py-2">
      {DJ_STEPS.map((step, idx) => {
