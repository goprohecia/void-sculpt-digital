            ...
            <div className="space-y-6">
              <MagneticButton as="div" strength={0.2}>
                <Link to="/" className="flex items-center gap-3 group inline-flex">
                  ...
                  />
                  <motion.span 
                    className="text-xl font-bold tracking-wider group-hover:text-neon-violet transition-colors"
          ...
          <ScrollReveal variant="fadeInUp" delay={0.1}>
            <div>
              <h4 className="font-semibold mb-6 text-neon-violet flex items-center gap-2">
                <motion.div 
                  className="w-2 h-2 rounded-full bg-neon-violet shadow-[0_0_10px_rgba(139,92,246,0.5)]"
              ...
              <StaggerContainer staggerDelay={0.05}>
                <ul className="space-y-3">
                  {[
                    ...
                    <motion.li key={link.to} variants={footerLinkVariants}>
                      <Link
                        to={link.to}
              ...
              <StaggerContainer staggerDelay={0.05} delayStart={0.1}>
                <ul className="space-y-3">
                  {[
                    ...
                    <motion.li key={index} variants={footerLinkVariants}>
                      <Link
                        to={link.to}
                        className="group flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors"
                      >
          ...
          <ScrollReveal variant="fadeInUp" delay={0.3}>
            <div>
              <h4 className="font-semibold mb-6 text-rose-400 flex items-center gap-2">
                <motion.div 
                  className="w-2 h-2 rounded-full bg-rose-400 shadow-[0_0_10px_rgba(251,113,133,0.5)]"
                  animate={{ scale: [1, 1.2, 1] }}
              ...
              <MagneticButton as="div" strength={0.15} className="mt-6 inline-block">
                <Link to="/contact">
                  <RippleButton
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-neon-violet/10 border border-neon-violet/40 text-neon-violet rounded-xl hover:bg-neon-violet/20 hover:border-neon-violet/60 transition-all duration-300"
                  >
                    Nous contacter
