import { CM_STEPS } from "@/data/mockCMData";
import { Check, FileText, CheckCircle, PenTool, ThumbsUp, CalendarCheck, Send, Flag } from "lucide-react";
import { cn } from "@/lib/utils";

const STEP_ICONS = [FileText, CheckCircle, PenTool, ThumbsUp, CalendarCheck, Send, Flag];

interface CMStepperProps {
  currentStep: number;
}

export function CMStepper({ currentStep }: CMStepperProps) {
  return (
