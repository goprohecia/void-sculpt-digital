import { Car, Search, FileText, CheckCircle, Wrench, Bell, Flag, Check, ChevronRight } from "lucide-react";
import { GARAGE_STEPS } from "@/data/mockGarageData";
import { Button } from "@/components/ui/button";
import { cn } from "@/lib/utils";

const STEP_ICONS = [Car, Search, FileText, CheckCircle, Wrench, Bell, Flag];
...
export function GarageVehicleStepper({ currentStep, stepDates, notes, isEditable, onAdvance }: Props) {
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        {GARAGE_STEPS.map((step, i) => {
      ...
      {isEditable && currentStep < GARAGE_STEPS.length - 1 && (
