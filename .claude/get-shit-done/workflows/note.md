...
- **Global scope**: `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/notes/`)
...
2. Glob `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/notes/` — works in any directory
