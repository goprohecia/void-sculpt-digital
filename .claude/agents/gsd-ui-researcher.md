...
Use template from `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/dylanrose/IMPARTIAL GAMES/PROJET INTERNE/void-sculpt-digital/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
